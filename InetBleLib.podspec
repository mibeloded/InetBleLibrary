...
Pod::Spec.new do |s|
  s.name             = 'InetBleLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of InetBleLib.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'mibeloded' => 'beloded@seniordev.com' }
  s.source           = { :git => 'https://github.com/mibeloded/InetBleLib.git', :tag => s.version.to_s }
